set moduleName LabelSelect_Batch
set isTopModule 0
...
set C_modelName {LabelSelect_Batch}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_V_V int 80 regular {fifo 0 volatile }  }
	{ out_V_V int 4 regular {fifo 1 volatile }  }
	{ numReps int 32 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_V_V", "interface" : "fifo", "bitwidth" : 80, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in_V_V_dout sc_in sc_lv 80 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_V_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":80, "type": "signal", "bundle":{"name": "in_V_V", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Testbench_label_sbkb_U5", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	in_V_V { ap_fifo {  { in_V_V_dout fifo_data 0 80 }  { in_V_V_empty_n fifo_status 0 1 }  { in_V_V_read fifo_update 1 1 } } }
