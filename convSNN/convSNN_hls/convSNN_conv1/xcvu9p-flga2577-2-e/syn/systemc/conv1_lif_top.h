...
struct conv1_lif_top : public sc_module {
    ...
    sc_signal< sc_logic > ap_channel_done_mul_ln124_loc_channe;
    sc_signal< sc_logic > mul_ln124_loc_channe_full_n;
    ...
    sc_signal< sc_lv<32> > mul_ln124_loc_channe_dout;
    sc_signal< sc_logic > mul_ln124_loc_channe_empty_n;
    ...
    void thread_ap_channel_done_mul_ln124_loc_channe();
    void thread_ap_done();
    void thread_ap_idle();
