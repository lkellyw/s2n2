...
#define AUTOTB_TVOUT_numEvents "../tv/cdatafile/c.conv1_lif_top.autotvout_numEvents.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_out_r "../tv/rtldatafile/rtl.conv1_lif_top.autotvout_out_r.dat"
...
extern "C"
void conv1_lif_top_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_conv1_lif_top_hw(void* __xlx_apatb_param_in_r, void* __xlx_apatb_param_out_r, hls::sim::Byte<4> __xlx_apatb_param_numEvents)
{
  static hls::sim::Stream<float> port0 {
    .width = 32,
    .name = "in_r",
#ifdef POST_CHECK
  ...
  port0.param = (hls::stream<float>*)__xlx_apatb_param_in_r;
  ...
  port1.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_out_r;
  port1.hasWrite = true;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_numEvents),
#endif
  };
  port2.param = &__xlx_apatb_param_numEvents;
  ...
  try {
    ...
    conv1_lif_top_hw_stub_wrapper(__xlx_apatb_param_in_r, __xlx_apatb_param_out_r, __xlx_apatb_param_numEvents);
    port1.buffer();
