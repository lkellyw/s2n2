...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fc1full_top.autotvin.dat"
	set constFileTvOut       "fc1full_top.autotvout.dat"
	set constFileHdlTvIn     "fc1full_top.autohdltvin.dat"
	set constFileHdlTvOut    "fc1full_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
