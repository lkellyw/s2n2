...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Testbench_label_select.autotvin.dat"
	set constFileTvOut       "Testbench_label_select.autotvout.dat"
	set constFileHdlTvIn     "Testbench_label_select.autohdltvin.dat"
	set constFileHdlTvOut    "Testbench_label_select.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
