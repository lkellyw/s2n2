...
#ifndef _conv1_lif_top_entry3_HH_
#define _conv1_lif_top_entry3_HH_
...
struct conv1_lif_top_entry3 : public sc_module {
    ...
    // Module declarations
    conv1_lif_top_entry3(sc_module_name name);
    SC_HAS_PROCESS(conv1_lif_top_entry3);
