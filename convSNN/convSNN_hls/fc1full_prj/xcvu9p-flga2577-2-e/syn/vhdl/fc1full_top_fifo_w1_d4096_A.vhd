...
entity fc1full_top_fifo_w1_d4096_A is
    generic (
...
architecture arch of fc1full_top_fifo_w1_d4096_A is

    -- component
    component fc1full_top_fifo_w1_d4096_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_fc1full_top_fifo_w1_d4096_A_ram : fc1full_top_fifo_w1_d4096_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity fc1full_top_fifo_w1_d4096_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 1;
        ADDR_WIDTH  : integer := 12;
...
architecture arch of fc1full_top_fifo_w1_d4096_A_ram is
