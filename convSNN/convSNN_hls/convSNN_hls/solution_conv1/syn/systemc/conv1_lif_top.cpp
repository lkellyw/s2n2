...
const sc_lv<8> conv1_lif_top::ap_const_lv8_0 = "00000000";
...
conv1_lif_top::conv1_lif_top(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    Matrix_Vector_Activa_U0->reps(shl_ln124_loc_channe_dout);
    ...
    shl_ln124_loc_channe_U = new fifo_w32_d2_A("shl_ln124_loc_channe_U");
    shl_ln124_loc_channe_U->clk(ap_clk);
    shl_ln124_loc_channe_U->reset(ap_rst);
    shl_ln124_loc_channe_U->if_read_ce(ap_var_for_const0);
    shl_ln124_loc_channe_U->if_write_ce(ap_var_for_const0);
    shl_ln124_loc_channe_U->if_din(Block_ZN8ap_fixedIL_U0_ap_return);
    shl_ln124_loc_channe_U->if_full_n(shl_ln124_loc_channe_full_n);
    shl_ln124_loc_channe_U->if_write(Block_ZN8ap_fixedIL_U0_ap_done);
    shl_ln124_loc_channe_U->if_dout(shl_ln124_loc_channe_dout);
    shl_ln124_loc_channe_U->if_empty_n(shl_ln124_loc_channe_empty_n);
    shl_ln124_loc_channe_U->if_read(Matrix_Vector_Activa_U0_ap_ready);
    ...
    sensitive << ( shl_ln124_loc_channe_full_n );
    ...
    sc_trace(mVcdFile, ap_channel_done_shl_ln124_loc_channe, "ap_channel_done_shl_ln124_loc_channe");
    sc_trace(mVcdFile, shl_ln124_loc_channe_full_n, "shl_ln124_loc_channe_full_n");
    ...
    sc_trace(mVcdFile, shl_ln124_loc_channe_dout, "shl_ln124_loc_channe_dout");
    sc_trace(mVcdFile, shl_ln124_loc_channe_empty_n, "shl_ln124_loc_channe_empty_n");
...
void conv1_lif_top::thread_Block_ZN8ap_fixedIL_U0_ap_continue() {
    Block_ZN8ap_fixedIL_U0_ap_continue = shl_ln124_loc_channe_full_n.read();
}
...
void conv1_lif_top::thread_Matrix_Vector_Activa_U0_ap_start() {
    Matrix_Vector_Activa_U0_ap_start = shl_ln124_loc_channe_empty_n.read();
}
...
void conv1_lif_top::thread_ap_channel_done_shl_ln124_loc_channe() {
    ap_channel_done_shl_ln124_loc_channe = Block_ZN8ap_fixedIL_U0_ap_done.read();
}
...
void conv1_lif_top::thread_ap_idle() {
    ap_idle = (conv1_lif_top_entry3_U0_ap_idle.read() & ConvolutionInputGene_U0_ap_idle.read() & Block_ZN8ap_fixedIL_U0_ap_idle.read() & Matrix_Vector_Activa_U0_ap_idle.read() & (shl_ln124_loc_channe_empty_n.read() ^ 
  ap_const_logic_1));
}
