...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Testbench_pool.autotvin.dat"
	set constFileTvOut       "Testbench_pool.autotvout.dat"
	set constFileHdlTvIn     "Testbench_pool.autohdltvin.dat"
	set constFileHdlTvOut    "Testbench_pool.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
