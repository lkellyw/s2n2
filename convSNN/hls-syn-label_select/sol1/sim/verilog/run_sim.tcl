...
if {[file isfile Testbench_label_select.autotvin.dat]} {
	file delete -force Testbench_label_select.autotvin.dat
}

if {[file isfile Testbench_label_select.autotvout.dat]} {
	file delete -force Testbench_label_select.autotvout.dat
}
