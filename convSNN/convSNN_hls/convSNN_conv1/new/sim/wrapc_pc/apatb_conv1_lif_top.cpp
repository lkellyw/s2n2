...
#define AUTOTB_TVOUT_PC_out_V_V  "../tv/rtldatafile/rtl.conv1_lif_top.autotvout_out_V_V.dat"
...
extern void conv1_lif_top (
hls::stream<ap_uint<3> > (&in),
hls::stream<ap_uint<32> > (&out),
unsigned int numReps);

void AESL_WRAP_conv1_lif_top (
hls::stream<ap_uint<3> > (&in),
hls::stream<ap_uint<32> > (&out),
unsigned int numReps)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		std::vector<ap_uint<32> > aesl_tmp_9;
		int aesl_tmp_10;
		int aesl_tmp_11 = 0;
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<32> > out_V_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_V_V
				{
					// bitslice(31, 0)
					// {
						// celement: out.V.V(31, 0)
						// {
							sc_lv<32>* out_V_V_lv0_0_0_1 = new sc_lv<32>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: out.V.V(31, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								{
									out_V_V_lv0_0_0_1[hls_map_index].range(31, 0) = sc_bv<32>(out_V_V_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		// dump stream tvin: "in"
		std::vector<ap_uint<3> > aesl_tmp_6;
		int aesl_tmp_7 = 0;
		while (!in.empty())
		{
...
// [call_c_dut] ---------->
     ...
     aesl_tmp_9.clear();
		...
		sc_bv<3>* in_V_V_tvin_wrapc_buffer = new sc_bv<3>[aesl_tmp_7 - aesl_tmp_8];
			...
			// bitslice(2, 0)
			{
				...
				// celement: in.V.V(2, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						{
							sc_lv<3> in_V_V_tmp_mem;
							in_V_V_tmp_mem = (aesl_tmp_6[i_0]).to_string(2).c_str();
							in_V_V_tvin_wrapc_buffer[hls_map_index].range(2, 0) = in_V_V_tmp_mem.range(2, 0);
                                 	       hls_map_index++;
						}
					}
				}
     ...
     if (aesl_tmp_7 > aesl_tmp_8)
     {
		...
		sc_bv<32>* out_V_V_tvout_wrapc_buffer = new sc_bv<32>[aesl_tmp_10 - aesl_tmp_11];
			...
			// bitslice(31, 0)
			{
				...
				// celement: out.V.V(31, 0)
				{
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						if (&(aesl_tmp_9[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> out_V_V_tmp_mem;
							out_V_V_tmp_mem = (aesl_tmp_9[i_0]).to_string(2).c_str();
							out_V_V_tvout_wrapc_buffer[hls_map_index].range(31, 0) = out_V_V_tmp_mem.range(31, 0);
                                 	       hls_map_index++;
						}
					}
				}
