...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fc2_top.autotvin_in_V_V.dat"
         "c.fc2_top.autotvin_out_V_V.dat"
         "c.fc2_top.autotvin_numReps.dat"
         "c.fc2_top.autotvout_out_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fc2_top.autotvout_out_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
