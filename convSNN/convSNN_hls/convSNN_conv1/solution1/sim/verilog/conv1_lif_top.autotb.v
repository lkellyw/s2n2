...
`define AESL_DEPTH_numEvents 1
`define AUTOTB_TVIN_in_r  "../tv/cdatafile/c.conv1_lif_top.autotvin_in_r.dat"
`define AUTOTB_TVIN_numEvents  "../tv/cdatafile/c.conv1_lif_top.autotvin_numEvents.dat"
`define AUTOTB_TVIN_in_r_out_wrapc  "../tv/rtldatafile/rtl.conv1_lif_top.autotvin_in_r.dat"
`define AUTOTB_TVIN_numEvents_out_wrapc  "../tv/rtldatafile/rtl.conv1_lif_top.autotvin_numEvents.dat"
`define AUTOTB_TVOUT_out_r  "../tv/cdatafile/c.conv1_lif_top.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "../tv/rtldatafile/rtl.conv1_lif_top.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_in_r = 30;
parameter LENGTH_numEvents = 1;
parameter LENGTH_out_r = 200;
...
// The signal of port numEvents
reg [31: 0] AESL_REG_numEvents = 0;
assign numEvents = AESL_REG_numEvents;
initial begin : read_file_process_numEvents
    integer fp;
    integer err;
    integer ret;
    integer proc_rand;
    ...
    transaction_idx = 0;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVIN_numEvents,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_numEvents);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_numEvents);
              if (ret != 1) begin
...
reg end_numEvents;
reg [31:0] size_numEvents;
reg [31:0] size_numEvents_backup;
reg end_out_r;
reg [31:0] size_out_r;
