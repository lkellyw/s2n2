# run_conv1full.tcl
open_project conv1full_prj
set_top conv1full_top
...
add_files $src_dir/conv1full_config.h -cflags $cflags
add_files $src_dir/conv1full_ref.h    -cflags $cflags
add_files $src_dir/conv1full_top.cpp  -cflags $cflags
...
add_files -tb $src_dir/conv1full_tb.cpp -cflags $cflags
