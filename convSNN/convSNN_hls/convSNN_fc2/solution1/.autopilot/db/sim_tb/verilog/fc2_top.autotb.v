...
`define AUTOTB_DUT      fc2_top
`define AUTOTB_DUT_INST AESL_inst_fc2_top
`define AUTOTB_TOP      apatb_fc2_top_top
`define AUTOTB_LAT_RESULT_FILE "fc2_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "fc2_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_fc2_top_top
...
`define AUTOTB_TVIN_in_V_V  "./c.fc2_top.autotvin_in_V_V.dat"
`define AUTOTB_TVIN_out_V_V  "./c.fc2_top.autotvin_out_V_V.dat"
`define AUTOTB_TVIN_numReps  "./c.fc2_top.autotvin_numReps.dat"
`define AUTOTB_TVIN_in_V_V_out_wrapc  "./rtl.fc2_top.autotvin_in_V_V.dat"
`define AUTOTB_TVIN_out_V_V_out_wrapc  "./rtl.fc2_top.autotvin_out_V_V.dat"
`define AUTOTB_TVIN_numReps_out_wrapc  "./rtl.fc2_top.autotvin_numReps.dat"
`define AUTOTB_TVOUT_out_V_V  "./c.fc2_top.autotvout_out_V_V.dat"
`define AUTOTB_TVOUT_out_V_V_out_wrapc  "./impl_rtl.fc2_top.autotvout_out_V_V.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.fc2_top.autotvout_out_V_V.dat", "r");
    fp2 = $fopen("./impl_rtl.fc2_top.autotvout_out_V_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.fc2_top.autotvout_out_V_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.fc2_top.autotvout_out_V_V.dat\"!");
    else begin
        $display("Comparing rtl.fc2_top.autotvout_out_V_V.dat with impl_rtl.fc2_top.autotvout_out_V_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
