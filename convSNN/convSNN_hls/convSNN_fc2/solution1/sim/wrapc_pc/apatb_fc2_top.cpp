...
#define AUTOTB_TVOUT_PC_out_V_V  "../tv/rtldatafile/rtl.fc2_top.autotvout_out_V_V.dat"
...
unsigned int numReps)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		std::vector<ap_uint<5> > aesl_tmp_9;
		int aesl_tmp_10;
		int aesl_tmp_11 = 0;
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<5> > out_V_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_V_V
				{
					// bitslice(4, 0)
					// {
						// celement: out.V.V(4, 0)
						// {
							sc_lv<5>* out_V_V_lv0_0_0_1 = new sc_lv<5>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
					...
					// bitslice(4, 0)
					{
						...
						// celement: out.V.V(4, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								{
									out_V_V_lv0_0_0_1[hls_map_index].range(4, 0) = sc_bv<5>(out_V_V_pc_buffer[hls_map_index].range(4, 0));
									hls_map_index++;
								}
							}
						}
...
// [call_c_dut] ---------->
     ...
     aesl_tmp_9.clear();
		...
		sc_bv<64>* in_V_V_tvin_wrapc_buffer = new sc_bv<64>[aesl_tmp_7 - aesl_tmp_8];
			...
			// bitslice(63, 0)
			{
				...
				// celement: in.V.V(63, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						{
							sc_lv<64> in_V_V_tmp_mem;
							in_V_V_tmp_mem = (aesl_tmp_6[i_0]).to_string(2).c_str();
							in_V_V_tvin_wrapc_buffer[hls_map_index].range(63, 0) = in_V_V_tmp_mem.range(63, 0);
                                 	       hls_map_index++;
						}
					}
				}
     ...
     if (aesl_tmp_7 > aesl_tmp_8)
     {
		...
		sc_bv<5>* out_V_V_tvout_wrapc_buffer = new sc_bv<5>[aesl_tmp_10 - aesl_tmp_11];
			...
			// bitslice(4, 0)
			{
				...
				// celement: out.V.V(4, 0)
				{
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						if (&(aesl_tmp_9[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<5> out_V_V_tmp_mem;
							out_V_V_tmp_mem = (aesl_tmp_9[i_0]).to_string(2).c_str();
							out_V_V_tvout_wrapc_buffer[hls_map_index].range(4, 0) = out_V_V_tmp_mem.range(4, 0);
                                 	       hls_map_index++;
						}
					}
				}
