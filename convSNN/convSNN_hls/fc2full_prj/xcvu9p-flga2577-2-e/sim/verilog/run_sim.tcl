...
if {[file isfile fc2full_top.autotvin.dat]} {
	file delete -force fc2full_top.autotvin.dat
}

if {[file isfile fc2full_top.autotvout.dat]} {
	file delete -force fc2full_top.autotvout.dat
}
