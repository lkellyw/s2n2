...
(* CORE_GENERATION_INFO="fc2_top_fc2_top,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flga2577-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.695000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=68,HLS_SYN_LUT=243,HLS_VERSION=2023_2}" *)
...
wire   [4:0] Matrix_Vector_Activate_Batch_U0_out_r_din;
wire    Matrix_Vector_Activate_Batch_U0_out_r_write;

fc2_top_Matrix_Vector_Activate_Batch Matrix_Vector_Activate_Batch_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
