...
define void @apatb_fc1_top_ir(%"class.hls::stream<ap_uint<16>, 0>"* noalias nocapture nonnull dereferenceable(2) %in, %"class.hls::stream<ap_uint<8>, 0>"* noalias nocapture nonnull dereferenceable(1) %out, i32 %numReps) local_unnamed_addr #1 {
entry:
  %in_copy = alloca i16, align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(i16* %in_copy, i32 0) ]
  %out_copy = alloca i8, align 512
  call void @llvm.sideeffect() #8 [ "stream_interface"(i8* %out_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<ap_uint<16>, 0>"* nonnull %in, i16* nonnull align 512 %in_copy, %"class.hls::stream<ap_uint<8>, 0>"* nonnull %out, i8* nonnull align 512 %out_copy)
  call void @apatb_fc1_top_hw(i16* %in_copy, i8* %out_copy, i32 %numReps)
  call void @copy_back(%"class.hls::stream<ap_uint<16>, 0>"* %in, i16* %in_copy, %"class.hls::stream<ap_uint<8>, 0>"* %out, i8* %out_copy)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<16>, 0>"(%"class.hls::stream<ap_uint<16>, 0>"* nonnull %dst, i16* align 512 %src)
  br label %ret
...
define void @fc1_top_hw_stub_wrapper(i16*, i8*, i32) #6 {
entry:
  %3 = alloca %"class.hls::stream<ap_uint<16>, 0>"
  %4 = alloca %"class.hls::stream<ap_uint<8>, 0>"
  call void @copy_out(%"class.hls::stream<ap_uint<16>, 0>"* %3, i16* %0, %"class.hls::stream<ap_uint<8>, 0>"* %4, i8* %1)
  call void @fc1_top_hw_stub(%"class.hls::stream<ap_uint<16>, 0>"* %3, %"class.hls::stream<ap_uint<8>, 0>"* %4, i32 %2)
  call void @copy_in(%"class.hls::stream<ap_uint<16>, 0>"* %3, i16* %0, %"class.hls::stream<ap_uint<8>, 0>"* %4, i8* %1)
  ret void
}

declare void @fc1_top_hw_stub(%"class.hls::stream<ap_uint<16>, 0>"*, %"class.hls::stream<ap_uint<8>, 0>"*, i32)
