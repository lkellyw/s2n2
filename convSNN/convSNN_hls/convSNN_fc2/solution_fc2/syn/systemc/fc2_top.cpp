...
const sc_logic fc2_top::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<5> fc2_top::ap_const_lv5_0 = "00000";
const sc_logic fc2_top::ap_const_logic_1 = sc_dt::Log_1;

fc2_top::fc2_top(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    apTFilenSS << "fc2_top_sc_trace_" << apTFileNum ++;
    ...
    mHdltvinHandle.open("fc2_top.hdltvin.dat");
    mHdltvoutHandle.open("fc2_top.hdltvout.dat");
}
