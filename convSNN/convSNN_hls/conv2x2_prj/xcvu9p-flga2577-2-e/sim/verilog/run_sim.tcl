...
if {[file isfile conv2x2_top.autotvin.dat]} {
	file delete -force conv2x2_top.autotvin.dat
}

if {[file isfile conv2x2_top.autotvout.dat]} {
	file delete -force conv2x2_top.autotvout.dat
}
