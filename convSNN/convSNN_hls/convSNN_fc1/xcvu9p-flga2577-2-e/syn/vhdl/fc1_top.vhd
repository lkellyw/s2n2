...
architecture behav of fc1_top is 
    ...
    "fc1_top_fc1_top,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flga2577-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.374000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=134,HLS_SYN_LUT=473,HLS_VERSION=2023_2}";
    ...
    signal Matrix_Vector_Activate_Batch_U0_out_r_din : STD_LOGIC_VECTOR (7 downto 0);
    signal Matrix_Vector_Activate_Batch_U0_out_r_write : STD_LOGIC;

    component fc1_top_Matrix_Vector_Activate_Batch IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    Matrix_Vector_Activate_Batch_U0 : component fc1_top_Matrix_Vector_Activate_Batch
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
