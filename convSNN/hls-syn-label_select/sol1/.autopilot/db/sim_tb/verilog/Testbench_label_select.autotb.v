...
`define AUTOTB_DUT      Testbench_label_select
`define AUTOTB_DUT_INST AESL_inst_Testbench_label_select
`define AUTOTB_TOP      apatb_Testbench_label_select_top
`define AUTOTB_LAT_RESULT_FILE "Testbench_label_select.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "Testbench_label_select.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_Testbench_label_select_top
...
`define AUTOTB_TVIN_in_V_V  "./c.Testbench_label_select.autotvin_in_V_V.dat"
`define AUTOTB_TVIN_out_V_V  "./c.Testbench_label_select.autotvin_out_V_V.dat"
`define AUTOTB_TVIN_numReps  "./c.Testbench_label_select.autotvin_numReps.dat"
`define AUTOTB_TVIN_in_V_V_out_wrapc  "./rtl.Testbench_label_select.autotvin_in_V_V.dat"
`define AUTOTB_TVIN_out_V_V_out_wrapc  "./rtl.Testbench_label_select.autotvin_out_V_V.dat"
`define AUTOTB_TVIN_numReps_out_wrapc  "./rtl.Testbench_label_select.autotvin_numReps.dat"
`define AUTOTB_TVOUT_out_V_V  "./c.Testbench_label_select.autotvout_out_V_V.dat"
`define AUTOTB_TVOUT_out_V_V_out_wrapc  "./impl_rtl.Testbench_label_select.autotvout_out_V_V.dat"
module `AUTOTB_TOP;
...
wire ready;
wire ready_wire;
wire [15 : 0] in_V_V_dout;
wire  in_V_V_empty_n;
wire  in_V_V_read;
wire [3 : 0] out_V_V_din;
wire  out_V_V_full_n;
wire  out_V_V_write;
wire [31 : 0] numReps;
wire ap_start;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.Testbench_label_select.autotvout_out_V_V.dat", "r");
    fp2 = $fopen("./impl_rtl.Testbench_label_select.autotvout_out_V_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Testbench_label_select.autotvout_out_V_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Testbench_label_select.autotvout_out_V_V.dat\"!");
    else begin
        $display("Comparing rtl.Testbench_label_select.autotvout_out_V_V.dat with impl_rtl.Testbench_label_select.autotvout_out_V_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
