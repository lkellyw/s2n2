...
using hls::sim::Byte;
extern "C" void conv1_lif_top(volatile void *, volatile void *, int);
extern "C" void apatb_conv1_lif_top_hw(volatile void * __xlx_apatb_param_in_r, volatile void * __xlx_apatb_param_out_r, int __xlx_apatb_param_numReps) {
using hls::sim::createStream;
auto* sin_r = createStream(__xlx_apatb_param_in_r, 1);
auto* sout_r = createStream(__xlx_apatb_param_out_r, 4);
  // DUT call
  conv1_lif_top(__xlx_apatb_param_in_r, __xlx_apatb_param_out_r, __xlx_apatb_param_numReps);
}
