...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.conv1_lif_top.autotvin_out_r.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.conv1_lif_top.autotvout_out_r.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 9;
parameter DEPTH = 32'd 200;
