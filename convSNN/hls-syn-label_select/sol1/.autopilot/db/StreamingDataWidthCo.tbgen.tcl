...
set portList { 
	...
	{ out_V_V_din sc_out sc_lv 80 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_V_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":80, "type": "signal", "bundle":{"name": "out_V_V", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	out_V_V { ap_fifo {  { out_V_V_din fifo_data 1 80 }  { out_V_V_full_n fifo_status 0 1 }  { out_V_V_write fifo_update 1 1 } } }
