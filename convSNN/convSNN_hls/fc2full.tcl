...
add_files $src_dir/fc2full_config.h -cflags $cflags
add_files $src_dir/fc2full_ref.h    -cflags $cflags
add_files $src_dir/fc2full_top.cpp  -cflags $cflags
...
add_files -tb $src_dir/fc2full_tb.cpp -cflags $cflags
