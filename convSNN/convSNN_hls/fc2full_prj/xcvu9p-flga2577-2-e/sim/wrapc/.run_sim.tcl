...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fc2full_top.autotvin.dat"
	set constFileTvOut       "fc2full_top.autotvout.dat"
	set constFileHdlTvIn     "fc2full_top.autohdltvin.dat"
	set constFileHdlTvOut    "fc2full_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
