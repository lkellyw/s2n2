...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fc1_top.autotvin.dat"
	set constFileTvOut       "fc1_top.autotvout.dat"
	set constFileHdlTvIn     "fc1_top.autohdltvin.dat"
	set constFileHdlTvOut    "fc1_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
