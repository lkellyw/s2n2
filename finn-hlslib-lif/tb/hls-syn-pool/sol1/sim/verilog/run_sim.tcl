...
if {[file isfile Testbench_pool.autotvin.dat]} {
	file delete -force Testbench_pool.autotvin.dat
}

if {[file isfile Testbench_pool.autotvout.dat]} {
	file delete -force Testbench_pool.autotvout.dat
}
