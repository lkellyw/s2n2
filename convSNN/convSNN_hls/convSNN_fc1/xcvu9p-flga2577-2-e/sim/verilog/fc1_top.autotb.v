...
`define AUTOTB_DUT      fc1_top
`define AUTOTB_DUT_INST AESL_inst_fc1_top
`define AUTOTB_TOP      apatb_fc1_top_top
`define AUTOTB_LAT_RESULT_FILE "fc1_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "fc1_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_fc1_top_top
...
`define AUTOTB_TVIN_in_V_V_out_wrapc  "../tv/rtldatafile/rtl.fc1_top.autotvin_in_V_V.dat"
`define AUTOTB_TVIN_out_V_V_out_wrapc  "../tv/rtldatafile/rtl.fc1_top.autotvin_out_V_V.dat"
`define AUTOTB_TVIN_numReps_out_wrapc  "../tv/rtldatafile/rtl.fc1_top.autotvin_numReps.dat"
`define AUTOTB_TVOUT_out_V_V  "../tv/cdatafile/c.fc1_top.autotvout_out_V_V.dat"
`define AUTOTB_TVOUT_out_V_V_out_wrapc  "../tv/rtldatafile/rtl.fc1_top.autotvout_out_V_V.dat"
module `AUTOTB_TOP;
