...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.conv2x2_top.autotvin_in_0.dat"
         "c.conv2x2_top.autotvin_in_1.dat"
         "c.conv2x2_top.autotvin_in_2.dat"
         "c.conv2x2_top.autotvin_in_3.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.conv2x2_top.autotvout_out_0.dat"
         "rtl.conv2x2_top.autotvout_out_1.dat"
         "rtl.conv2x2_top.autotvout_out_2.dat"
         "rtl.conv2x2_top.autotvout_out_3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
