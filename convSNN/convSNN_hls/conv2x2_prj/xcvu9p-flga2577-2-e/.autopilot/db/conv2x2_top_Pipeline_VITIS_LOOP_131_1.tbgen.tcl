set moduleName conv2x2_top_Pipeline_VITIS_LOOP_131_1
set isTopModule 0
...
set C_modelName {conv2x2_top_Pipeline_VITIS_LOOP_131_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ out_stream int 1 regular {fifo 1 volatile }  }
	{ convInp int 1 regular {fifo 0 volatile }  }
	{ temp_4 int 2 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "out_stream", "interface" : "fifo", "bitwidth" : 1, "direction" : "WRITEONLY"} , 
 	{ "Name" : "convInp", "interface" : "fifo", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "temp_4", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ convInp_dout sc_in sc_lv 1 signal 1 } 
	{ convInp_empty_n sc_in sc_logic 1 signal 1 } 
	{ convInp_read sc_out sc_logic 1 signal 1 } 
	{ out_stream_din sc_out sc_lv 1 signal 0 } 
	{ out_stream_full_n sc_in sc_logic 1 signal 0 } 
	{ out_stream_write sc_out sc_logic 1 signal 0 } 
	{ temp_4 sc_in sc_lv 2 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "convInp_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "convInp", "role": "dout" }} , 
 	...
 	{ "name": "temp_4", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "temp_4", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_4_2_16_1_1_U15", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	convInp { ap_fifo {  { convInp_dout fifo_port_we 0 1 }  { convInp_empty_n fifo_status 0 1 }  { convInp_read fifo_data 1 1 } } }
	temp_4 { ap_none {  { temp_4 in_data 0 2 } } }
}
set moduleName conv2x2_top_Pipeline_VITIS_LOOP_131_1
set isTopModule 0
set isCombinational 0
...
set C_modelArgList {
	{ out_stream int 1 regular {fifo 1 volatile }  }
	{ swu_out int 1 regular {fifo 0 volatile }  }
	{ temp_4 int 2 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "out_stream", "interface" : "fifo", "bitwidth" : 1, "direction" : "WRITEONLY"} , 
 	{ "Name" : "swu_out", "interface" : "fifo", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "temp_4", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} ]}
# RTL Port declarations: 
set portNum 13
set portList { 
	...
	{ ap_idle sc_out sc_logic 1 done -1 } 
	{ ap_ready sc_out sc_logic 1 ready -1 } 
	{ swu_out_dout sc_in sc_lv 1 signal 1 } 
	{ swu_out_empty_n sc_in sc_logic 1 signal 1 } 
	{ swu_out_read sc_out sc_logic 1 signal 1 } 
	{ out_stream_din sc_out sc_lv 1 signal 0 } 
	{ out_stream_full_n sc_in sc_logic 1 signal 0 } 
	{ out_stream_write sc_out sc_logic 1 signal 0 } 
	{ temp_4 sc_in sc_lv 2 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ap_idle", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "done", "bundle":{"name": "ap_idle", "role": "default" }} , 
 	{ "name": "ap_ready", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "ready", "bundle":{"name": "ap_ready", "role": "default" }} , 
 	{ "name": "swu_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "swu_out", "role": "dout" }} , 
 	{ "name": "swu_out_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "swu_out", "role": "empty_n" }} , 
 	{ "name": "swu_out_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "swu_out", "role": "read" }} , 
 	{ "name": "out_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "out_stream", "role": "din" }} , 
 	{ "name": "out_stream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_stream", "role": "full_n" }} , 
 	{ "name": "out_stream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_stream", "role": "write" }} , 
 	{ "name": "temp_4", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "temp_4", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	out_stream { ap_fifo {  { out_stream_din fifo_port_we 1 1 }  { out_stream_full_n fifo_status 0 1 }  { out_stream_write fifo_data 1 1 } } }
	swu_out { ap_fifo {  { swu_out_dout fifo_port_we 0 1 }  { swu_out_empty_n fifo_status 0 1 }  { swu_out_read fifo_data 1 1 } } }
	temp_4 { ap_none {  { temp_4 in_data 0 2 } } }
}
set moduleName conv2x2_top_Pipeline_VITIS_LOOP_131_1
set isTopModule 0
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_131_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_4_2_16_1_1_U14", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}
