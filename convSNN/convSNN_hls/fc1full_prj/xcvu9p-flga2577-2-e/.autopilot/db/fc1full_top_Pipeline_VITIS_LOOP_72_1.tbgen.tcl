set moduleName fc1full_top_Pipeline_VITIS_LOOP_72_1
set isTopModule 0
...
set C_modelName {fc1full_top_Pipeline_VITIS_LOOP_72_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_r int 1 regular {array 3200 { 1 3 } 1 1 }  }
	{ in_stream int 1 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "in_r", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in_stream_din sc_out sc_lv 1 signal 1 } 
	{ in_stream_full_n sc_in sc_logic 1 signal 1 } 
	{ in_stream_write sc_out sc_logic 1 signal 1 } 
	{ in_r_address0 sc_out sc_lv 12 signal 0 } 
	{ in_r_ce0 sc_out sc_logic 1 signal 0 } 
	{ in_r_q0 sc_in sc_lv 1 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_r_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "in_r", "role": "q0" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "fc1full_top_Pipeline_VITIS_LOOP_72_1",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	fc1full_top_Pipeline_VITIS_LOOP_72_1 {
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3202", "Max" : "3202"}
	, {"Name" : "Interval", "Min" : "3202", "Max" : "3202"}
]}
...
set Spec2ImplPortList { 
	in_r { ap_memory {  { in_r_address0 mem_address 1 12 }  { in_r_ce0 mem_ce 1 1 }  { in_r_q0 in_data 0 1 } } }
