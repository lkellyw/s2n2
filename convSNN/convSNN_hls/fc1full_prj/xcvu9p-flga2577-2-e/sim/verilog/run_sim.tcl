...
if {[file isfile fc1full_top.autotvin.dat]} {
	file delete -force fc1full_top.autotvin.dat
}

if {[file isfile fc1full_top.autotvout.dat]} {
	file delete -force fc1full_top.autotvout.dat
}
