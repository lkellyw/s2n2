...
unsigned int ap_apatb_in_r_cap_bc;
...
using hls::sim::Byte;
extern "C" void conv1_lif_top(float*, int*, int);
extern "C" void apatb_conv1_lif_top_hw(volatile void * __xlx_apatb_param_in_r, volatile void * __xlx_apatb_param_out_r, int __xlx_apatb_param_numEvents) {
using hls::sim::createStream;
auto* sin_r = createStream((hls::stream<float>*)__xlx_apatb_param_in_r);
...
auto* sout_r = createStream((hls::stream<int>*)__xlx_apatb_param_out_r);
  // DUT call
  conv1_lif_top(sin_r->data<float>(), sout_r->data<int>(), __xlx_apatb_param_numEvents);
sin_r->transfer((hls::stream<float>*)__xlx_apatb_param_in_r);
