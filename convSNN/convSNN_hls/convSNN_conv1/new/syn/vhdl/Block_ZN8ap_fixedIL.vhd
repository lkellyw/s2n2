...
architecture behav of Block_ZN8ap_fixedIL is 
    ...
    signal mul_ln124_fu_26_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul_ln124_fu_26_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((ap_start = ap_const_logic_0) or (numReps_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                                        ap_return_preg(31 downto 2) <= mul_ln124_fu_26_p2(31 downto 2);
                end if; 
            end if;
        end if;
    end process;

    ap_return_preg(1 downto 0) <= "00";
    ...
    ap_return_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, numReps_empty_n, mul_ln124_fu_26_p2, ap_return_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (numReps_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return <= mul_ln124_fu_26_p2;
        else 
            ap_return <= ap_return_preg;
        end if; 
    end process;

    mul_ln124_fu_26_p0 <= numReps_dout;
    mul_ln124_fu_26_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(mul_ln124_fu_26_p0) * signed('0' &ap_const_lv32_64))), 32));
