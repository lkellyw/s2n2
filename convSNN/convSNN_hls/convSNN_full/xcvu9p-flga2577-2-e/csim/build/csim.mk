...
HLS_SOURCES = ../../../../../convSNN_tb.cpp ../../../../../fc2_top.cpp ../../../../../fc1_top.cpp ../../../../../conv1_top.cpp ../../../../../convSNN_top.cpp
...
$(ObjDir)/convSNN_tb.o: ../../../../../convSNN_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../convSNN_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
$(ObjDir)/convSNN_top.o: ../../../../../convSNN_top.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../convSNN_top.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -I/home/coder/Desktop/s2n2/finn-hlslib-lif -std=c++0x  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/convSNN_top.d
