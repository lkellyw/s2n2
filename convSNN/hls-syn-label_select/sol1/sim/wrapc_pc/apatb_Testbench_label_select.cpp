...
#define AUTOTB_TVOUT_PC_out_V_V  "../tv/rtldatafile/rtl.Testbench_label_select.autotvout_out_V_V.dat"
...
extern void Testbench_label_select (
hls::stream<ap_uint<16> > (&in),
hls::stream<ap_uint<4> > (&out),
unsigned int numReps);

void AESL_WRAP_Testbench_label_select (
hls::stream<ap_uint<16> > (&in),
hls::stream<ap_uint<4> > (&out),
unsigned int numReps)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<4> > out_V_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_V_V
				{
					// bitslice(3, 0)
					// {
						// celement: out.V.V(3, 0)
						// {
							sc_lv<4>* out_V_V_lv0_0_0_1 = new sc_lv<4>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
					...
					// bitslice(3, 0)
					{
						...
						// celement: out.V.V(3, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								{
									out_V_V_lv0_0_0_1[hls_map_index].range(3, 0) = sc_bv<4>(out_V_V_pc_buffer[hls_map_index].range(3, 0));
									hls_map_index++;
								}
							}
						}
...
// [call_c_dut] ---------->
		...
		Testbench_label_select(in, out, numReps);
     ...
     aesl_tmp_9.clear();
		...
		sc_bv<16>* in_V_V_tvin_wrapc_buffer = new sc_bv<16>[aesl_tmp_7 - aesl_tmp_8];
			...
			// bitslice(15, 0)
			{
				...
				// celement: in.V.V(15, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						{
							sc_lv<16> in_V_V_tmp_mem;
							in_V_V_tmp_mem = (aesl_tmp_6[i_0]).to_string(2).c_str();
							in_V_V_tvin_wrapc_buffer[hls_map_index].range(15, 0) = in_V_V_tmp_mem.range(15, 0);
                                 	       hls_map_index++;
						}
					}
				}
     ...
     if (aesl_tmp_7 > aesl_tmp_8)
     {
		...
		sc_bv<4>* out_V_V_tvout_wrapc_buffer = new sc_bv<4>[aesl_tmp_10 - aesl_tmp_11];
			...
			// bitslice(3, 0)
			{
				...
				// celement: out.V.V(3, 0)
				{
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						if (&(aesl_tmp_9[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<4> out_V_V_tmp_mem;
							out_V_V_tmp_mem = (aesl_tmp_9[i_0]).to_string(2).c_str();
							out_V_V_tvout_wrapc_buffer[hls_map_index].range(3, 0) = out_V_V_tmp_mem.range(3, 0);
                                 	       hls_map_index++;
						}
					}
				}
