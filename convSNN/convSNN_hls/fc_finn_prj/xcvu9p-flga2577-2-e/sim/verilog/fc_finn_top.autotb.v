...
`define AUTOTB_DUT      fc_finn_top
`define AUTOTB_DUT_INST AESL_inst_fc_finn_top
`define AUTOTB_TOP      apatb_fc_finn_top_top
`define AUTOTB_LAT_RESULT_FILE "fc_finn_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "fc_finn_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_fc_finn_top_top
...
`define AUTOTB_TVIN_in_0_out_wrapc  "../tv/rtldatafile/rtl.fc_finn_top.autotvin_in_0.dat"
`define AUTOTB_TVIN_in_1_out_wrapc  "../tv/rtldatafile/rtl.fc_finn_top.autotvin_in_1.dat"
`define AUTOTB_TVIN_in_2_out_wrapc  "../tv/rtldatafile/rtl.fc_finn_top.autotvin_in_2.dat"
`define AUTOTB_TVIN_in_3_out_wrapc  "../tv/rtldatafile/rtl.fc_finn_top.autotvin_in_3.dat"
`define AUTOTB_TVIN_in_4_out_wrapc  "../tv/rtldatafile/rtl.fc_finn_top.autotvin_in_4.dat"
`define AUTOTB_TVIN_in_5_out_wrapc  "../tv/rtldatafile/rtl.fc_finn_top.autotvin_in_5.dat"
`define AUTOTB_TVIN_in_6_out_wrapc  "../tv/rtldatafile/rtl.fc_finn_top.autotvin_in_6.dat"
`define AUTOTB_TVIN_in_7_out_wrapc  "../tv/rtldatafile/rtl.fc_finn_top.autotvin_in_7.dat"
...
`define AUTOTB_TVOUT_out_0_out_wrapc  "../tv/rtldatafile/rtl.fc_finn_top.autotvout_out_0.dat"
`define AUTOTB_TVOUT_out_1_out_wrapc  "../tv/rtldatafile/rtl.fc_finn_top.autotvout_out_1.dat"
`define AUTOTB_TVOUT_out_2_out_wrapc  "../tv/rtldatafile/rtl.fc_finn_top.autotvout_out_2.dat"
`define AUTOTB_TVOUT_out_3_out_wrapc  "../tv/rtldatafile/rtl.fc_finn_top.autotvout_out_3.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 94;
