...
HLS_SOURCES = ../../../../maxpool_tb.cpp ../../../../pool_top.cpp
...
$(ObjDir)/maxpool_tb.o: ../../../../maxpool_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../maxpool_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
$(ObjDir)/pool_top.o: ../../../../pool_top.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../pool_top.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
