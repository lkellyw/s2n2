...
#
# Generated by export_simulation on Thu Sep 25 03:03:58 UTC 2025
#
################################################################################
...
'-reset_run' switch to the './SNNtrial2.sh' script.

./SNNtrial2.sh -reset_run
...
./SNNtrial2.sh -noclean_files

For more information on the script, please type './SNNtrial2.sh -help'.
