...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.Testbench_pool.autotvin_in_V_V.dat"
         "c.Testbench_pool.autotvin_out_V_V.dat"
         "c.Testbench_pool.autotvin_numReps.dat"
         "c.Testbench_pool.autotvout_out_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Testbench_pool.autotvout_out_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
