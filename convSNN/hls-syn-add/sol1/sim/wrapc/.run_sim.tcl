...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Testbench_add.autotvin.dat"
	set constFileTvOut       "Testbench_add.autotvout.dat"
	set constFileHdlTvIn     "Testbench_add.autohdltvin.dat"
	set constFileHdlTvOut    "Testbench_add.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
