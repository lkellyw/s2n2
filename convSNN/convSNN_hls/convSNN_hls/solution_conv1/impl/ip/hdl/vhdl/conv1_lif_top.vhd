...
architecture behav of conv1_lif_top is 
    ...
    "conv1_lif_top,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu28dr-ffvg1517-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.755000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=32,HLS_SYN_DSP=0,HLS_SYN_FF=1139,HLS_SYN_LUT=3420,HLS_VERSION=2020_1}";
    ...
    signal ap_channel_done_shl_ln124_loc_channe : STD_LOGIC;
    signal shl_ln124_loc_channe_full_n : STD_LOGIC;
    ...
    signal Matrix_Vector_Activa_U0_out_V_V_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal shl_ln124_loc_channe_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal shl_ln124_loc_channe_empty_n : STD_LOGIC;
...
begin
    ...
    port map (
        ...
        reps => shl_ln124_loc_channe_dout);
    ...
    shl_ln124_loc_channe_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => shl_ln124_loc_channe_full_n,
        if_write => Block_ZN8ap_fixedIL_U0_ap_done,
        if_dout => shl_ln124_loc_channe_dout,
        if_empty_n => shl_ln124_loc_channe_empty_n,
    ...
    Block_ZN8ap_fixedIL_U0_ap_continue <= shl_ln124_loc_channe_full_n;
    ...
    Matrix_Vector_Activa_U0_ap_start <= shl_ln124_loc_channe_empty_n;
    Matrix_Vector_Activa_U0_start_full_n <= ap_const_logic_1;
    Matrix_Vector_Activa_U0_start_write <= ap_const_logic_0;
    ap_channel_done_shl_ln124_loc_channe <= Block_ZN8ap_fixedIL_U0_ap_done;
    ap_done <= Matrix_Vector_Activa_U0_ap_done;
    ap_idle <= ((shl_ln124_loc_channe_empty_n xor ap_const_logic_1) and conv1_lif_top_entry3_U0_ap_idle and Matrix_Vector_Activa_U0_ap_idle and ConvolutionInputGene_U0_ap_idle and Block_ZN8ap_fixedIL_U0_ap_idle);
