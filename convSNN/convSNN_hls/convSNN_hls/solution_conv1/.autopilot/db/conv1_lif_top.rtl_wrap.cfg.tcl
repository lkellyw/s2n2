...
set structArgument3 [list 3 $DataType3ta1 8 4 ]
set NameSpace3 [list ]
set structIsPacked3 "0"
set DataType3 [list "FixedPointWeightsSp<3, ap_int<32>, 8, 4>" "struct FixedPointWeightsSp" $structMem3 1 0 $structParameter3 $structArgument3 $NameSpace3 $structIsPacked3]
