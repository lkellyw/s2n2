...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fc2_top.autotvin.dat"
	set constFileTvOut       "fc2_top.autotvout.dat"
	set constFileHdlTvIn     "fc2_top.autohdltvin.dat"
	set constFileHdlTvOut    "fc2_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
