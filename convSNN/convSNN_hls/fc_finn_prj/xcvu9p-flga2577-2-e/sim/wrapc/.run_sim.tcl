...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fc_finn_top.autotvin.dat"
	set constFileTvOut       "fc_finn_top.autotvout.dat"
	set constFileHdlTvIn     "fc_finn_top.autohdltvin.dat"
	set constFileHdlTvOut    "fc_finn_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
