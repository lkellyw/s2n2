...
architecture behav of Block_ZN8ap_fixedIL is 
    ...
    signal numReps_read_reg_31 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    ap_return <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(numReps_read_reg_31) * signed('0' &ap_const_lv32_64))), 32));
