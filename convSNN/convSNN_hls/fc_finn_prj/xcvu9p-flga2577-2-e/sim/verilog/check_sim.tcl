...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fc_finn_top.autotvin_in_0.dat"
         "c.fc_finn_top.autotvin_in_1.dat"
         "c.fc_finn_top.autotvin_in_2.dat"
         "c.fc_finn_top.autotvin_in_3.dat"
         "c.fc_finn_top.autotvin_in_4.dat"
         "c.fc_finn_top.autotvin_in_5.dat"
         "c.fc_finn_top.autotvin_in_6.dat"
         "c.fc_finn_top.autotvin_in_7.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fc_finn_top.autotvout_out_0.dat"
         "rtl.fc_finn_top.autotvout_out_1.dat"
         "rtl.fc_finn_top.autotvout_out_2.dat"
         "rtl.fc_finn_top.autotvout_out_3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
