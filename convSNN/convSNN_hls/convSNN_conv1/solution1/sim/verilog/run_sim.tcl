...
if {[file isfile conv1_lif_top.autotvin.dat]} {
	file delete -force conv1_lif_top.autotvin.dat
}

if {[file isfile conv1_lif_top.autotvout.dat]} {
	file delete -force conv1_lif_top.autotvout.dat
}
