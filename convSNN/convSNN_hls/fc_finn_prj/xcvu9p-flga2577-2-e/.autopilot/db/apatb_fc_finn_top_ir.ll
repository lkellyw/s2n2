; ModuleID = '/home/coder/Desktop/s2n2/convSNN/convSNN_hls/fc_finn_prj/xcvu9p-flga2577-2-e/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_fc_finn_top_ir(%"struct.ap_uint<1>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="8" "partition" %in, %"struct.ap_uint<1>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="4" "partition" %out) local_unnamed_addr #0 {
entry:
  ...
  %0 = bitcast %"struct.ap_uint<1>"* %in to [8 x %"struct.ap_uint<1>"]*
  %1 = bitcast %"struct.ap_uint<1>"* %out to [4 x %"struct.ap_uint<1>"]*
  call void @copy_in([8 x %"struct.ap_uint<1>"]* nonnull %0, i1* nonnull align 512 %in_copy_0, i1* nonnull align 512 %in_copy_1, i1* nonnull align 512 %in_copy_2, i1* nonnull align 512 %in_copy_3, i1* nonnull align 512 %in_copy_4, i1* nonnull align 512 %in_copy_5, i1* nonnull align 512 %in_copy_6, i1* nonnull align 512 %in_copy_7, [4 x %"struct.ap_uint<1>"]* nonnull %1, i1* nonnull align 512 %out_copy_0, i1* nonnull align 512 %out_copy_1, i1* nonnull align 512 %out_copy_2, i1* nonnull align 512 %out_copy_3)
  call void @apatb_fc_finn_top_hw(i1* %in_copy_0, i1* %in_copy_1, i1* %in_copy_2, i1* %in_copy_3, i1* %in_copy_4, i1* %in_copy_5, i1* %in_copy_6, i1* %in_copy_7, i1* %out_copy_0, i1* %out_copy_1, i1* %out_copy_2, i1* %out_copy_3)
  call void @copy_back([8 x %"struct.ap_uint<1>"]* %0, i1* %in_copy_0, i1* %in_copy_1, i1* %in_copy_2, i1* %in_copy_3, i1* %in_copy_4, i1* %in_copy_5, i1* %in_copy_6, i1* %in_copy_7, [4 x %"struct.ap_uint<1>"]* %1, i1* %out_copy_0, i1* %out_copy_1, i1* %out_copy_2, i1* %out_copy_3)
  ret void
}
...
for.loop:                                         ; preds = %dst.addr.0.0.06.exit, %for.loop.lr.ph
  ...
  %src.addr.0.0.05 = getelementptr [8 x %"struct.ap_uint<1>"], [8 x %"struct.ap_uint<1>"]* %src, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a4struct.ap_uint<1>"(i1* nocapture "orig.arg.no"="0" "unpacked"="0.0.0" %dst_0, i1* nocapture "orig.arg.no"="0" "unpacked"="0.0.1" %dst_1, i1* nocapture "orig.arg.no"="0" "unpacked"="0.0.2" %dst_2, i1* nocapture "orig.arg.no"="0" "unpacked"="0.0.3" %dst_3, [4 x %"struct.ap_uint<1>"]* readonly "orig.arg.no"="1" "unpacked"="1" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @"onebyonecpy_hls.p0a4struct.ap_uint<1>"(i1* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.0" %dst_0, i1* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.1" %dst_1, i1* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.2" %dst_2, i1* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.3" %dst_3, [4 x %"struct.ap_uint<1>"]* noalias readonly "orig.arg.no"="1" "unpacked"="1" %src) #2 {
entry:
  %0 = icmp eq [4 x %"struct.ap_uint<1>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a4struct.ap_uint<1>"(i1* %dst_0, i1* %dst_1, i1* %dst_2, i1* %dst_3, [4 x %"struct.ap_uint<1>"]* nonnull %src, i64 4)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a8struct.ap_uint<1>"([8 x %"struct.ap_uint<1>"]* "orig.arg.no"="0" "unpacked"="0" %dst, i1* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.0" %src_0, i1* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.1" %src_1, i1* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.2" %src_2, i1* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.3" %src_3, i1* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.4" %src_4, i1* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.5" %src_5, i1* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.6" %src_6, i1* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.7" %src_7, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
  %0 = icmp eq [8 x %"struct.ap_uint<1>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
for.loop:                                         ; preds = %src.addr.0.0.05.exit, %for.loop.lr.ph
  ...
  %1 = trunc i64 %for.loop.idx2 to i3
  %dst.addr.0.0.06 = getelementptr [8 x %"struct.ap_uint<1>"], [8 x %"struct.ap_uint<1>"]* %dst, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
...
src.addr.0.0.05.exit:                             ; preds = %src.addr.0.0.05.case.7, %src.addr.0.0.05.case.6, %src.addr.0.0.05.case.5, %src.addr.0.0.05.case.4, %src.addr.0.0.05.case.3, %src.addr.0.0.05.case.2, %src.addr.0.0.05.case.1, %src.addr.0.0.05.case.0
  %26 = phi i1 [ %4, %src.addr.0.0.05.case.0 ], [ %7, %src.addr.0.0.05.case.1 ], [ %10, %src.addr.0.0.05.case.2 ], [ %13, %src.addr.0.0.05.case.3 ], [ %16, %src.addr.0.0.05.case.4 ], [ %19, %src.addr.0.0.05.case.5 ], [ %22, %src.addr.0.0.05.case.6 ], [ %25, %src.addr.0.0.05.case.7 ]
  store i1 %26, i1* %dst.addr.0.0.06, align 1
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse
define internal void @"onebyonecpy_hls.p0a8struct.ap_uint<1>"([8 x %"struct.ap_uint<1>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, i1* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.0" %src_0, i1* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.1" %src_1, i1* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.2" %src_2, i1* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.3" %src_3, i1* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.4" %src_4, i1* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.5" %src_5, i1* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.6" %src_6, i1* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.7" %src_7) #2 {
entry:
  %0 = icmp eq [8 x %"struct.ap_uint<1>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a8struct.ap_uint<1>"([8 x %"struct.ap_uint<1>"]* nonnull %dst, i1* %src_0, i1* %src_1, i1* %src_2, i1* %src_3, i1* %src_4, i1* %src_5, i1* %src_6, i1* %src_7, i64 8)
  br label %ret
...
declare void @apatb_fc_finn_top_hw(i1*, i1*, i1*, i1*, i1*, i1*, i1*, i1*, i1*, i1*, i1*, i1*)
...
define void @fc_finn_top_hw_stub_wrapper(i1*, i1*, i1*, i1*, i1*, i1*, i1*, i1*, i1*, i1*, i1*, i1*) #5 {
entry:
  %12 = alloca [8 x %"struct.ap_uint<1>"]
  %13 = alloca [4 x %"struct.ap_uint<1>"]
  call void @copy_out([8 x %"struct.ap_uint<1>"]* %12, i1* %0, i1* %1, i1* %2, i1* %3, i1* %4, i1* %5, i1* %6, i1* %7, [4 x %"struct.ap_uint<1>"]* %13, i1* %8, i1* %9, i1* %10, i1* %11)
  %14 = bitcast [8 x %"struct.ap_uint<1>"]* %12 to %"struct.ap_uint<1>"*
  %15 = bitcast [4 x %"struct.ap_uint<1>"]* %13 to %"struct.ap_uint<1>"*
  call void @fc_finn_top_hw_stub(%"struct.ap_uint<1>"* %14, %"struct.ap_uint<1>"* %15)
  call void @copy_in([8 x %"struct.ap_uint<1>"]* %12, i1* %0, i1* %1, i1* %2, i1* %3, i1* %4, i1* %5, i1* %6, i1* %7, [4 x %"struct.ap_uint<1>"]* %13, i1* %8, i1* %9, i1* %10, i1* %11)
  ret void
}

declare void @fc_finn_top_hw_stub(%"struct.ap_uint<1>"*, %"struct.ap_uint<1>"*)
