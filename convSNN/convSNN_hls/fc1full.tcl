...
add_files $src_dir/fc1full_config.h -cflags $cflags
add_files $src_dir/fc1full_ref.h    -cflags $cflags
add_files $src_dir/fc1full_top.cpp  -cflags $cflags
...
add_files -tb $src_dir/fc1full_tb.cpp -cflags $cflags
