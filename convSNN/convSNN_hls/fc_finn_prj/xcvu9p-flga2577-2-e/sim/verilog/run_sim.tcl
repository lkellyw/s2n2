...
if {[file isfile fc_finn_top.autotvin.dat]} {
	file delete -force fc_finn_top.autotvin.dat
}

if {[file isfile fc_finn_top.autotvout.dat]} {
	file delete -force fc_finn_top.autotvout.dat
}
