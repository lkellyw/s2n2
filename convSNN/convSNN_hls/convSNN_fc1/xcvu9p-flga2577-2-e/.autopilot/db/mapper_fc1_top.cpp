...
using hls::sim::Byte;
extern "C" void fc1_top(short*, char*, int);
...
auto* sin_r = createStream((hls::stream<short>*)__xlx_apatb_param_in_r);
...
auto* sout_r = createStream((hls::stream<char>*)__xlx_apatb_param_out_r);
  // DUT call
  fc1_top(sin_r->data<short>(), sout_r->data<char>(), __xlx_apatb_param_numReps);
sin_r->transfer((hls::stream<short>*)__xlx_apatb_param_in_r);
