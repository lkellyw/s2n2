...
if {[file isfile Testbench_add.autotvin.dat]} {
	file delete -force Testbench_add.autotvin.dat
}

if {[file isfile Testbench_add.autotvout.dat]} {
	file delete -force Testbench_add.autotvout.dat
}
