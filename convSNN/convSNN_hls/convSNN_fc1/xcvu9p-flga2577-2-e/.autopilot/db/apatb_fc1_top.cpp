...
extern "C"
void fc1_top_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_fc1_top_hw(void* __xlx_apatb_param_in_r, void* __xlx_apatb_param_out_r, hls::sim::Byte<4> __xlx_apatb_param_numReps)
{
  ...
  port0.param = (hls::stream<hls::sim::Byte<2>>*)__xlx_apatb_param_in_r;
  ...
  port1.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_out_r;
  port1.hasWrite = true;
