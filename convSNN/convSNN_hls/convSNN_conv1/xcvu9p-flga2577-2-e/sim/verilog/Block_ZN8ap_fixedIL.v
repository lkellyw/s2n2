...
reg    numReps_blk_n;
reg    ap_block_state1;
wire  signed [31:0] mul_ln124_fu_26_p0;
wire   [31:0] mul_ln124_fu_26_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (numReps_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_preg[31 : 2] <= mul_ln124_fu_26_p2[31 : 2];
        end
    end
end
...
assign mul_ln124_fu_26_p0 = numReps_dout;

assign mul_ln124_fu_26_p2 = ($signed(mul_ln124_fu_26_p0) * $signed('h64));
