...
set ::env(LD_LIBRARY_PATH) /tools/Xilinx/Vitis_HLS/2023.1/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "conv1_lif_top.autotvin.dat"
	set constFileTvOut       "conv1_lif_top.autotvout.dat"
	set constFileHdlTvIn     "conv1_lif_top.autohdltvin.dat"
	set constFileHdlTvOut    "conv1_lif_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
