...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "conv2x2_top.autotvin.dat"
	set constFileTvOut       "conv2x2_top.autotvout.dat"
	set constFileHdlTvIn     "conv2x2_top.autohdltvin.dat"
	set constFileHdlTvOut    "conv2x2_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
